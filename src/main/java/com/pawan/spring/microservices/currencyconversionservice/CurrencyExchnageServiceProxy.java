...
//@FeignClient(name="currency-exchange-service", url="localhost:3000")
...
public interface CurrencyExchnageServiceProxy {
	...
	public CurrencyConversion reteriveCurrencyValue(@PathVariable("from") String from,@PathVariable("to") String to);
}
